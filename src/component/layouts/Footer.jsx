      ...
      <footer className="relative z-10 text-text  container mx-auto px-8 md:px-12 py-6 md:py-10 md:pt-20">
        ...
        <div className="flex flex-col lg:flex-row gap-25">
          ...
          <div className="lg:w-2/5">
            <h2 className="text-2xl font-bold text-primary">SOLE-CRAFTS</h2>
          ...
          <div className="lg:w-1/5">
            <h3 className="text-sm font-semibold text-primary mb-2">Follow Us</h3>
          ...
          <div className="lg:w-2/5">
            ...
            <p className="text-sm ">
              ...
              <span className="font-medium">Phone:</span> 9742938274 <br />
              <span className="font-medium">Email:</span> Prajwaladhikari754@gmail.com
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm ">
              ...
              <li className="hover:text-primary cursor-pointer transition-colors">Shop</li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm ">
              ...
              <li className="hover:text-primary cursor-pointer transition-colors">Order History</li>
        ...
        {/* Bottom */}
        <div className="mt-16 border-t pt-6 text-center text-sm text-muted">
