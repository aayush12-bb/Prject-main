          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full px-4">
            ...
            <div className="flex items-center space-x-3  bg-gray-50 p-4 rounded-lg shadow-sm hover:shadow-md transition">
              ...
              <div className="text-black text-sm text-left">
                <p className="font-medium">Tel: 9808076243</p>
                <p className="font-medium">Email: juttachapal@gmail.com</p>
              </div>
            </div>
        ...
        <div className=" mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 px-6 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              <button
                type="submit"
                className="w-40 h-11 bg-primary text-black rounded-md mt-2 hover:scale-105 transition-transform"
              >
                Submit
              </button>
            </form>
